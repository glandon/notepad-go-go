...
-x : Move Notpad++ to indicated left side position on the screen\r\
-y : Move Notpad++ to indicated top position on the screen\r\
-monitor: Open file with file monitoring enabled\r\
-nosession : Launch Notpad++ without previous session\r\
-notabbar : Launch Notpad++ without tabbar\r\
-ro : Make the filePath read only\r\
-systemtray : Launch Notpad++ directly in system tray\r\
-loadingTime : Display Notpad++ loading time\r\
-alwaysOnTop : Make Notpad++ always on top\r\
...
-quickPrint : Print the file given as argument then quit Notpad++\r\
...
-titleAdd=\"string\": add string to Notpad++ title bar\r\
...
private:
	...
	static constexpr wchar_t _className[32] = L"Notpad++";
